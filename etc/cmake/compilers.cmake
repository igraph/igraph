...
# Helper function to add preprocesor definition of __IGRAPH_FILE_BASENAME__
...
#
# Will add -D__IGRAPH_FILE_BASENAME__="filename" for each source file depended
...
function(define_file_basename_for_sources targetname)
  ...
  foreach(sourcefile ${source_files})
    # Add the __IGRAPH_FILE_BASENAME__=filename compile definition to the list.
    get_filename_component(basename "${sourcefile}" NAME)
    # Set the updated compile definitions on the source file.
    set_property(
      SOURCE "${sourcefile}" APPEND
      PROPERTY COMPILE_DEFINITIONS "__IGRAPH_FILE_BASENAME__=\"${basename}\""
    )
  endforeach()
endfunction()
