...
void gnp(igraph_int_t n, igraph_real_t p, igraph_bool_t directed, igraph_bool_t loops) {
    igraph_t g;
    igraph_erdos_renyi_game_gnp(&g, n, p, directed, loops, false);
    igraph_destroy(&g);
}

void gnm(igraph_int_t n, igraph_real_t meandeg, igraph_bool_t directed, igraph_bool_t loops) {
    igraph_t g;
    igraph_erdos_renyi_game_gnm(&g, n, round(directed ? n * meandeg : 0.5 * n * meandeg), directed, loops, false);
    igraph_destroy(&g);
}
...
void run_bench(igraph_int_t vcount, igraph_real_t meandeg, igraph_int_t rep) {
    ...
    igraph_erdos_renyi_game_gnp(&g, vcount, p, IGRAPH_UNDIRECTED, IGRAPH_NO_LOOPS, false);
    ...
    igraph_erdos_renyi_game_gnp(&g, vcount, p, IGRAPH_DIRECTED, IGRAPH_NO_LOOPS, false);
