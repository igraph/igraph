...
int main(void) {
    ...
    igraph_barabasi_game(&template, 1000, /* power = */ 1, /* m = */ 1,
        /* outseq = */ NULL, /* outpref = */ 1, /* A = */ 0,
        IGRAPH_UNDIRECTED, IGRAPH_BARABASI_PSUMTREE, /* start_from = */ 0
    );
    ...
    igraph_rng_seed(igraph_rng_default(), 42);
    igraph_vector_int_init(&degrees, 0);
    igraph_erdos_renyi_game_gnm(&template, 200, 600, IGRAPH_UNDIRECTED, /* loops = */ 0);
    igraph_degree(&template, &degrees, igraph_vss_all(), IGRAPH_ALL, 1);
    ...
    igraph_barabasi_game(&template, 5000, /* power = */ 1, /* m = */ 2,
        /* outseq = */ NULL, /* outpref = */ 1, /* A = */ 0,
        IGRAPH_DIRECTED, IGRAPH_BARABASI_PSUMTREE, /* start_from = */ 0
    );
    igraph_degree(&template, &outdeg, igraph_vss_all(), IGRAPH_OUT, 1);
    igraph_degree(&template, &indeg, igraph_vss_all(), IGRAPH_IN, 1);
    ...
    igraph_vector_int_init(&outdeg, 0);
    igraph_vector_int_init(&indeg, 0);
    igraph_erdos_renyi_game_gnm(&template, 15000, 45000, IGRAPH_DIRECTED, /* loops = */ 0);
    igraph_degree(&template, &outdeg, igraph_vss_all(), IGRAPH_OUT, 1);
    igraph_degree(&template, &indeg, igraph_vss_all(), IGRAPH_IN, 1);
