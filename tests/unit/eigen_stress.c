...
int main(void) {
    ...
    for (igraph_integer_t i=0; i < 1252; i++) {
        ...
        CHECK_PRINT(igraph_eigenvector_centrality(&g, &vec, &val, IGRAPH_UNDIRECTED, true, NULL, NULL));
        CHECK_PRINT(igraph_hub_and_authority_scores(&g, &vec, NULL, &val, true, NULL, NULL));

        igraph_to_directed(&g, IGRAPH_TO_DIRECTED_RANDOM);
        CHECK_PRINT(igraph_eigenvector_centrality(&g, &vec, &val, IGRAPH_DIRECTED, true, NULL, NULL));
        CHECK_PRINT(igraph_hub_and_authority_scores(&g, &vec, NULL, &val, true, NULL, NULL));
    ...
    for (igraph_integer_t i=3; i < 100; i++) {
        ...
        CHECK_PRINT(igraph_eigenvector_centrality(&g, &vec, NULL, IGRAPH_DIRECTED, true, NULL, NULL));
        igraph_destroy(&g);
    }
