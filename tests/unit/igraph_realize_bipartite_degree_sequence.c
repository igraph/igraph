...
int main(void) {
    ...
    igraph_realize_bipartite_degree_sequence(&g, &ds1, &ds2, IGRAPH_SIMPLE_SW);
    ...
    igraph_realize_bipartite_degree_sequence(&g, &ds1, &ds2, IGRAPH_MULTI_SW);
    ...
    // TODO: Add a random check for random degree sequences
//    printf("===Random===\n");
//    igraph_t rg;
...
//            igraph_vector_int_print(&ds2);
//            fail++;
//        } else if (is_bipartite & potentially_connected & is_connected) {
//            success++;
//        } else if (is_bipartite & !potentially_connected & !is_connected) {
//            success++;
//        }
