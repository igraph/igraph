...
int main(void) {
    ...
    igraph_erdos_renyi_game_gnp(&g, 100, 0.1, IGRAPH_UNDIRECTED, IGRAPH_SIMPLE_SW, false);
    ...
    igraph_erdos_renyi_game_gnp(&g, 50, 0.3, IGRAPH_UNDIRECTED, IGRAPH_SIMPLE_SW, false);
