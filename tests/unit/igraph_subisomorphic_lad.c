...
void test_motifs(void) {
    ...
    igraph_erdos_renyi_game_gnm(&graph, 30, 400, IGRAPH_DIRECTED, IGRAPH_SIMPLE_SW);
...
void test_motifs_undirected(void) {
    ...
    igraph_erdos_renyi_game_gnm(&graph, 18, 80, IGRAPH_UNDIRECTED, IGRAPH_SIMPLE_SW);
     ...
     * The graph is chosen to have slightly higher than 50% density
     * so that most connected motifs have a high chance of appearing. */
    igraph_erdos_renyi_game_gnm(&graph, 12, 36, IGRAPH_UNDIRECTED, IGRAPH_SIMPLE_SW);
