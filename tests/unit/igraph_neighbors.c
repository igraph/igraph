...
int main(void) {
    igraph_t g_1, g_lm, g_lmu, g_lmmlu, g_s1, g_s2;

    /* g_1: one vertex */
    igraph_small(&g_1, 1, 0, -1);

    /* g_lm: graph with loop and multiple edges, directed */
    igraph_small(&g_lm, 6, 1, 0,1, 0,2, 1,1, 1,3, 2,0, 2,0, 2,3, 3,4, 3,4, -1);

    /* g_lmu: graph with loop and multiple edges, undirected */
    igraph_small(&g_lmu, 6, 0, 0,1, 0,2, 1,1, 1,3, 2,0, 2,0, 2,3, 3,4, 3,4, -1);

    /* g_lmmlu: graph with loop, multiple and multiple loop edges, undirected */
    igraph_small(&g_lmmlu, 5, 0,
        0, 1, 0, 3, 0, 8,
        1, 2,
        2, 2, 2, 3,
        3, 0, 3, 4,
    ...
    call_and_print(&g_lm, 1, IGRAPH_OUT, IGRAPH_LOOPS_TWICE, IGRAPH_MULTIPLE);
    ...
    printf("Vertex 2 with single loop edge, undirected, IGRAPH_NO_LOOPS, IGRAPH_NO_MULTIPLE:\n");
    call_and_print(&g_lmmlu, 2, IGRAPH_ALL, IGRAPH_NO_LOOPS, IGRAPH_NO_MULTIPLE);

    printf("Vertex 2 with single loop edge, undirected, IGRAPH_LOOPS_ONCE, IGRAPH_NO_MULTIPLE:\n");
    call_and_print(&g_lmmlu, 2, IGRAPH_ALL, IGRAPH_LOOPS_ONCE, IGRAPH_NO_MULTIPLE);

    printf("Vertex 2 with single loop edge, undirected, IGRAPH_LOOPS_TWICE, IGRAPH_NO_MULTIPLE:\n");
    call_and_print(&g_lmmlu, 2, IGRAPH_ALL, IGRAPH_LOOPS_TWICE, IGRAPH_NO_MULTIPLE);

    printf("Vertex 2 with single loop edge, undirected, IGRAPH_NO_LOOPS, IGRAPH_MULTIPLE:\n");
    call_and_print(&g_lmmlu, 2, IGRAPH_ALL, IGRAPH_NO_LOOPS, IGRAPH_MULTIPLE);

    printf("Vertex 2 with single loop edge, undirected, IGRAPH_LOOPS_ONCE, IGRAPH_MULTIPLE:\n");
    call_and_print(&g_lmmlu, 2, IGRAPH_ALL, IGRAPH_LOOPS_ONCE, IGRAPH_MULTIPLE);

    printf("Vertex 2 with single loop edge, undirected, IGRAPH_LOOPS_TWICE, IGRAPH_MULTIPLE:\n");
    call_and_print(&g_lmmlu, 2, IGRAPH_ALL, IGRAPH_LOOPS_TWICE, IGRAPH_MULTIPLE);

    printf("Vertex 4 with multiple loop edges, undirected, IGRAPH_NO_LOOPS, IGRAPH_NO_MULTIPLE:\n");
    call_and_print(&g_lmmlu, 4, IGRAPH_ALL, IGRAPH_NO_LOOPS, IGRAPH_NO_MULTIPLE);

    printf("Vertex 4 with multiple loop edges, undirected, IGRAPH_LOOPS_ONCE, IGRAPH_NO_MULTIPLE:\n");
    call_and_print(&g_lmmlu, 4, IGRAPH_ALL, IGRAPH_LOOPS_ONCE, IGRAPH_NO_MULTIPLE);

    printf("Vertex 4 with multiple loop edges, undirected, IGRAPH_LOOPS_TWICE, IGRAPH_NO_MULTIPLE:\n");
    call_and_print(&g_lmmlu, 4, IGRAPH_ALL, IGRAPH_LOOPS_TWICE, IGRAPH_NO_MULTIPLE);

    printf("Vertex 4 with multiple loop edges, undirected, IGRAPH_NO_LOOPS, IGRAPH_MULTIPLE:\n");
    call_and_print(&g_lmmlu, 4, IGRAPH_ALL, IGRAPH_NO_LOOPS, IGRAPH_MULTIPLE);

    printf("Vertex 4 with multiple loop edges, undirected, IGRAPH_LOOPS_ONCE, IGRAPH_MULTIPLE:\n");
    call_and_print(&g_lmmlu, 4, IGRAPH_ALL, IGRAPH_LOOPS_ONCE, IGRAPH_MULTIPLE);

    printf("Vertex 4 with multiple loop edges, undirected, IGRAPH_LOOPS_TWICE, IGRAPH_MULTIPLE:\n");
    call_and_print(&g_lmmlu, 4, IGRAPH_ALL, IGRAPH_LOOPS_TWICE, IGRAPH_MULTIPLE);
    ...
    IGRAPH_ASSERT(igraph_neighbors(&g_lm, &neis, 0, IGRAPH_OUT, IGRAPH_LOOPS_TWICE, IGRAPH_NO_MULTIPLE) == IGRAPH_EINVAL);
    */
