...
void test_undirected(void) {
    ...
    /* Random graph */
    igraph_erdos_renyi_game_gnm(&graph, 10, 20, IGRAPH_UNDIRECTED, IGRAPH_LOOPS_SW | IGRAPH_MULTI_SW, false);
    igraph_feedback_vertex_set(&graph, &result, NULL, IGRAPH_FVS_EXACT_IP);
    check_fvs(&graph, &result);
    igraph_destroy(&graph);
...
void test_directed(void) {
    ...
    /* Random graph */
    igraph_erdos_renyi_game_gnm(&graph, 10, 20, IGRAPH_DIRECTED, IGRAPH_LOOPS_SW | IGRAPH_MULTI_SW, false);
    igraph_feedback_vertex_set(&graph, &result, NULL, IGRAPH_FVS_EXACT_IP);
    check_fvs(&graph, &result);
    igraph_destroy(&graph);
