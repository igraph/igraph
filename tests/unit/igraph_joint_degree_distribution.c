...
int main(void) {
    ...
    igraph_erdos_renyi_game_gnm(&dg, 10, 30, IGRAPH_DIRECTED, IGRAPH_LOOPS_SW, false);
    check_jdm(&dg, NULL);
    check_assort(&dg, NULL);
    check_knnk(&dg, NULL);
    ...
    igraph_erdos_renyi_game_gnm(&ug, 10, 30, IGRAPH_UNDIRECTED, IGRAPH_LOOPS_SW, false);
    check_jdm(&ug, NULL);
    check_assort(&ug, NULL);
    check_knnk(&ug, NULL);
