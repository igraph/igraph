...
int main(void) {
    ...
    igraph_vector_int_init_int(&types, 0);
    ...
    printf("No edges:\n");
    igraph_vector_init_int(&pref, 2, 1, 1);
    igraph_vector_int_init_int(&types, 3, 1, 1, 1);
    ...
    igraph_vector_int_init_int(&types, 5, 0, 1, 1, 1, 1);
    ...
    igraph_vector_int_init_int(&types, 7, 0, 1, 2, 3, 4, 5, 6);
    ...
    igraph_vector_init_real(&pref, 2, 1.0, 1.0);
    igraph_vector_int_init_int(&types, 2, 0, -5);
