...
int main(void) {
    ...
    for (size_t i=0; i < sizeof(modes) / sizeof(modes[0]); i++) {
        check_gnp(0, 0, 0, IGRAPH_UNDIRECTED, modes[i], IGRAPH_NO_MULTIPLE, false);
        check_gnp(2, 3, 0, IGRAPH_UNDIRECTED, modes[i], IGRAPH_NO_MULTIPLE, false);
        check_gnp(0, 0, 0, IGRAPH_UNDIRECTED, modes[i], IGRAPH_MULTIPLE, false);
        check_gnp(2, 3, 0, IGRAPH_UNDIRECTED, modes[i], IGRAPH_MULTIPLE, false);

        check_gnp(8, 15, 0.8, IGRAPH_UNDIRECTED, modes[i], IGRAPH_NO_MULTIPLE, true);
        check_gnp(6, 3, 1, IGRAPH_UNDIRECTED, modes[i], IGRAPH_NO_MULTIPLE, true);
        check_gnp(8, 15, 0.8, IGRAPH_UNDIRECTED, modes[i], IGRAPH_MULTIPLE, true);
        check_gnp(6, 3, 1, IGRAPH_UNDIRECTED, modes[i], IGRAPH_MULTIPLE, true);
    }
