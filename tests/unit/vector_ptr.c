...
int main() {
    ...
    igraph_long_t i;
    void ** ptr;
    igraph_long_t d1 = 1, d2 = 2, d3 = 3, d4 = 4, d5 = 5;
    ...
    for (i = 0; i < igraph_vector_ptr_size(&v3); i++) {
        if ( *((igraph_long_t*)VECTOR(v3)[i]) != i + 1) {
            return 17;
        }
    }
    ...
    for (i = 0; i < igraph_vector_ptr_size(&v1); i++) {
        if ( *((igraph_long_t*)VECTOR(v1)[i]) != i + 1) {
            return 18;
        }
    }
    ...
    for (i = 0; i < igraph_vector_ptr_size(&v2); i++) {
        if ( *((igraph_long_t*)VECTOR(v2)[i]) != i + 1) {
            return 20;
        }
    }
    ...
    if ( *((igraph_long_t*)VECTOR(v2)[0]) != 2) {
        return 21;
    }
    if ( *((igraph_long_t*)VECTOR(v2)[1]) != 3) {
        return 22;
    }
    if ( *((igraph_long_t*)VECTOR(v2)[2]) != 4) {
        return 23;
    }
