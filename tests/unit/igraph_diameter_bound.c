...
int main(void) {
    ...
    igraph_diameter_bound(&g, &result, NULL, IGRAPH_UNDIRECTED, 0);
    ...
    igraph_diameter_bound(&g, &result, NULL, IGRAPH_UNDIRECTED, false);
    ...
    igraph_diameter_bound(&g, &result, NULL, IGRAPH_UNDIRECTED, true);
