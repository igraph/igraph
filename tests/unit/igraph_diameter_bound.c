...
int main(void) {
    ...
    igraph_barabasi_game(&g, 30, /*power=*/ 1, 30, 0, 0, /*A=*/ 1,
                         ...
                         /*start_from=*/ 0);
    igraph_diameter_bound(&g, &result, -1, NULL, NULL, IGRAPH_UNDIRECTED, 1);
    ...
    igraph_diameter_bound(&g, &result, -1, &from, &to, IGRAPH_DIRECTED, 1);
    ...
    igraph_diameter_bound(&g, &result, -1, NULL, NULL, IGRAPH_DIRECTED, 1);
    print_real(stdout, result, "%g");
    printf("\nuconn = False \n");
    igraph_diameter_bound(&g, &result, -1, NULL, NULL, IGRAPH_DIRECTED, 0);
    print_real(stdout, result, "%g");
