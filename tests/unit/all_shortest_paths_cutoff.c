...
int main(void) {
    ...
    igraph_get_all_shortest_paths_cutoff(&graph, &paths, NULL, &nrgeo, from, igraph_vss_1(to), IGRAPH_ALL, 3);
    ...
    igraph_get_all_shortest_paths_dijkstra_cutoff(&graph, &paths, NULL, &nrgeo, from, igraph_vss_1(to), &weights, IGRAPH_ALL, 3);
    ...
    igraph_get_all_shortest_paths_cutoff(&graph, &paths, &paths_edge, &nrgeo, from, igraph_vss_1(to), IGRAPH_ALL, 3);
    ...
    igraph_get_all_shortest_paths_dijkstra_cutoff(&graph, &paths, &paths_edge, &nrgeo, from, igraph_vss_1(to), &weights, IGRAPH_ALL, 4);
    ...
    igraph_get_all_shortest_paths_dijkstra_cutoff(&graph, &paths, &paths_edge, &nrgeo, from, igraph_vss_1(to), &weights, IGRAPH_ALL, 8);
    ...
    igraph_get_all_shortest_paths_dijkstra_cutoff(&graph, &paths, &paths_edge, &nrgeo, from, igraph_vss_all(), &weights, IGRAPH_ALL, 10);
