...
int test_no_multiple(void) {
    ...
    igraph_erdos_renyi_game_gnm(&g, 0, 0, IGRAPH_UNDIRECTED, IGRAPH_NO_LOOPS, IGRAPH_NO_MULTIPLE);
    ...
    igraph_erdos_renyi_game_gnm(&g, 1, 0, IGRAPH_UNDIRECTED, IGRAPH_NO_LOOPS, IGRAPH_NO_MULTIPLE);
    ...
    igraph_erdos_renyi_game_gnm(&g, 100000, 200000, IGRAPH_UNDIRECTED, IGRAPH_NO_LOOPS, IGRAPH_NO_MULTIPLE);
    IGRAPH_ASSERT(igraph_vcount(&g) == 100000);
    IGRAPH_ASSERT(igraph_ecount(&g) == 200000);
    igraph_is_simple(&g, &simple); IGRAPH_ASSERT(simple);
    igraph_destroy(&g);

    igraph_erdos_renyi_game_gnm(&g, 100000, 200000, IGRAPH_DIRECTED, IGRAPH_NO_LOOPS, IGRAPH_NO_MULTIPLE);
    IGRAPH_ASSERT(igraph_vcount(&g) == 100000);
    IGRAPH_ASSERT(igraph_ecount(&g) == 200000);
    igraph_is_simple(&g, &simple); IGRAPH_ASSERT(simple);
    igraph_destroy(&g);

    igraph_erdos_renyi_game_gnm(&g, 100000, 200000, IGRAPH_UNDIRECTED, IGRAPH_LOOPS, IGRAPH_NO_MULTIPLE);
    IGRAPH_ASSERT(igraph_vcount(&g) == 100000);
    IGRAPH_ASSERT(igraph_ecount(&g) == 200000);
    igraph_has_multiple(&g, &has_multi); IGRAPH_ASSERT(! has_multi);
    ...
    igraph_erdos_renyi_game_gnm(&g, 100000, 200000, IGRAPH_DIRECTED, IGRAPH_LOOPS, IGRAPH_NO_MULTIPLE);
    IGRAPH_ASSERT(igraph_vcount(&g) == 100000);
    IGRAPH_ASSERT(igraph_ecount(&g) == 200000);
    igraph_has_multiple(&g, &has_multi); IGRAPH_ASSERT(! has_multi);
    igraph_destroy(&g);
...
int test_multiple(void) {
    ...
    igraph_erdos_renyi_game_gnm(&graph1, 1000, 200000, IGRAPH_UNDIRECTED, IGRAPH_NO_LOOPS, IGRAPH_MULTIPLE);
    IGRAPH_ASSERT(igraph_vcount(&graph1) == 1000);
    IGRAPH_ASSERT(igraph_ecount(&graph1) == 200000);
    igraph_has_loop(&graph1, &has_loop); IGRAPH_ASSERT(! has_loop);
    igraph_destroy(&graph1);

    igraph_erdos_renyi_game_gnm(&graph1, 100000, 200000, IGRAPH_DIRECTED, IGRAPH_NO_LOOPS, IGRAPH_MULTIPLE);
    IGRAPH_ASSERT(igraph_vcount(&graph1) == 100000);
    IGRAPH_ASSERT(igraph_ecount(&graph1) == 200000);
    igraph_has_loop(&graph1, &has_loop); IGRAPH_ASSERT(! has_loop);
    igraph_destroy(&graph1);

    igraph_erdos_renyi_game_gnm(&graph1, 100000, 200000, IGRAPH_UNDIRECTED, IGRAPH_LOOPS, IGRAPH_MULTIPLE);
    IGRAPH_ASSERT(igraph_vcount(&graph1) == 100000);
    IGRAPH_ASSERT(igraph_ecount(&graph1) == 200000);
    igraph_destroy(&graph1);

    igraph_erdos_renyi_game_gnm(&graph1, 100000, 200000, IGRAPH_DIRECTED, IGRAPH_LOOPS, IGRAPH_MULTIPLE);
    IGRAPH_ASSERT(igraph_vcount(&graph1) == 100000);
    IGRAPH_ASSERT(igraph_ecount(&graph1) == 200000);
    igraph_destroy(&graph1);
