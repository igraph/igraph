...
int main(void) {
    ...
    igraph_distances_floyd_warshall_tree_speedup(&g, &d, NULL, IGRAPH_IN);
    print_matrix(&d);
    ...
    igraph_distances_floyd_warshall_tree_speedup(&g, &d, NULL, IGRAPH_ALL);
    print_matrix(&d);
    ...
    printf("\nWeighted directed\n");
    igraph_distances_floyd_warshall_tree_speedup(&g, &d, &weights, IGRAPH_OUT);
    print_matrix(&d);
    ...
    printf("\nWeighted undirected\n");
    igraph_distances_floyd_warshall_tree_speedup(&g, &d, &weights, IGRAPH_ALL);
    print_matrix(&d);
    ...
    CHECK_ERROR(igraph_distances_floyd_warshall_tree_speedup(&g, &d, &weights, IGRAPH_ALL), IGRAPH_ENEGLOOP);

    /* Negative cycle in directed graph */
    VECTOR(weights)[1] = -10;
    CHECK_ERROR(igraph_distances_floyd_warshall_tree_speedup(&g, &d, &weights, IGRAPH_OUT), IGRAPH_ENEGLOOP);
