...
int main(void) {
...

    {
        ...
        igraph_erdos_renyi_game_gnm(&g1, 10, 30, IGRAPH_DIRECTED, IGRAPH_SIMPLE_SW, false);
        igraph_erdos_renyi_game_gnm(&g2, 10, 30, IGRAPH_DIRECTED, IGRAPH_SIMPLE_SW, false);
