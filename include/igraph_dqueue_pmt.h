...
DECLDIR igraph_integer_t FUNCTION(igraph_dqueue, init)    (TYPE(igraph_dqueue)* q, igraph_integer_t size);
...
DECLDIR igraph_integer_t FUNCTION(igraph_dqueue, size)    (const TYPE(igraph_dqueue)* q);
...
DECLDIR igraph_integer_t FUNCTION(igraph_dqueue, push)    (TYPE(igraph_dqueue)* q, BASE elem);
DECLDIR igraph_integer_t FUNCTION(igraph_dqueue, print)(const TYPE(igraph_dqueue)* q);
DECLDIR igraph_integer_t FUNCTION(igraph_dqueue, fprint)(const TYPE(igraph_dqueue)* q, FILE *file);
DECLDIR BASE FUNCTION(igraph_dqueue, e)(const TYPE(igraph_dqueue) *q, igraph_integer_t idx);
