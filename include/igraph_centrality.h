...
IGRAPH_EXPORT igraph_error_t igraph_linkrank(
        const igraph_t *graph, const igraph_vector_t *weights,
        igraph_vector_t *vector, igraph_real_t *value,
        igraph_bool_t directed, igraph_real_t damping,
        igraph_pagerank_algo_t algo, igraph_arpack_options_t *options);

IGRAPH_EXPORT igraph_error_t igraph_personalized_linkrank(
        const igraph_t *graph, const igraph_vector_t *weights,
        igraph_vector_t *vector, igraph_real_t *value,
        igraph_bool_t directed, igraph_real_t damping,
        const igraph_vector_t *reset,
...
IGRAPH_EXPORT igraph_error_t igraph_personalized_linkrank_vs(
        const igraph_t *graph, const igraph_vector_t *weights,
        igraph_vector_t *vector, igraph_real_t *value,
        igraph_bool_t directed, igraph_real_t damping,
