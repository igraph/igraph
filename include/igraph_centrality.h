...
igraph_edge_betweenness_subset(const igraph_t *graph, const igraph_vector_t *weights, igraph_vector_t *res,
                               igraph_vs_t targets, igraph_vs_t sources, igraph_es_t eids, igraph_bool_t directed,
                               igraph_bool_t normalized);
