...
DECLDIR igraph_error_t igraph_attribute_combination_init(igraph_attribute_combination_t *comb);
DECLDIR igraph_error_t igraph_attribute_combination(igraph_attribute_combination_t *comb, ...);
DECLDIR void igraph_attribute_combination_destroy(igraph_attribute_combination_t *comb);
DECLDIR igraph_error_t igraph_attribute_combination_add(igraph_attribute_combination_t *comb,
        const char *name,
        igraph_attribute_combination_type_t type,
        igraph_function_pointer_t func);
DECLDIR igraph_error_t igraph_attribute_combination_remove(igraph_attribute_combination_t *comb,
        const char *name);
DECLDIR igraph_error_t igraph_attribute_combination_query(const igraph_attribute_combination_t *comb,
        const char *name,
        igraph_attribute_combination_type_t *type,
        igraph_function_pointer_t *func);
...
typedef struct igraph_attribute_table_t {
    ...
    igraph_error_t (*add_vertices)(igraph_t *graph, igraph_long_t nv, igraph_vector_ptr_t *attr);
...
DECLDIR igraph_error_t igraph_cattribute_VANV(const igraph_t *graph, const char *name,
                                   igraph_vs_t vids, igraph_vector_t *result);
DECLDIR igraph_error_t igraph_cattribute_EANV(const igraph_t *graph, const char *name,
                                   igraph_es_t eids, igraph_vector_t *result);
DECLDIR igraph_error_t igraph_cattribute_VASV(const igraph_t *graph, const char *name,
                                   igraph_vs_t vids, igraph_strvector_t *result);
DECLDIR igraph_error_t igraph_cattribute_EASV(const igraph_t *graph, const char *name,
                                   igraph_es_t eids, igraph_strvector_t *result);
DECLDIR igraph_error_t igraph_cattribute_VABV(const igraph_t *graph, const char *name,
                                   igraph_vs_t vids, igraph_vector_bool_t *result);
DECLDIR igraph_error_t igraph_cattribute_EABV(const igraph_t *graph, const char *name,
                                   igraph_es_t eids, igraph_vector_bool_t *result);

DECLDIR igraph_error_t igraph_cattribute_list(const igraph_t *graph,
                                   igraph_strvector_t *gnames, igraph_vector_t *gtypes,
                                   igraph_strvector_t *vnames, igraph_vector_t *vtypes,
                                   igraph_strvector_t *enames, igraph_vector_t *etypes);
...
DECLDIR igraph_error_t igraph_cattribute_GAN_set(igraph_t *graph, const char *name,
                                      igraph_real_t value);
DECLDIR igraph_error_t igraph_cattribute_GAB_set(igraph_t *graph, const char *name,
                                      igraph_bool_t value);
DECLDIR igraph_error_t igraph_cattribute_GAS_set(igraph_t *graph, const char *name,
                                      const char *value);
DECLDIR igraph_error_t igraph_cattribute_VAN_set(igraph_t *graph, const char *name,
                                      igraph_long_t vid, igraph_real_t value);
DECLDIR igraph_error_t igraph_cattribute_VAB_set(igraph_t *graph, const char *name,
                                      igraph_long_t vid, igraph_bool_t value);
DECLDIR igraph_error_t igraph_cattribute_VAS_set(igraph_t *graph, const char *name,
                                      igraph_long_t vid, const char *value);
DECLDIR igraph_error_t igraph_cattribute_EAN_set(igraph_t *graph, const char *name,
                                      igraph_long_t eid, igraph_real_t value);
DECLDIR igraph_error_t igraph_cattribute_EAB_set(igraph_t *graph, const char *name,
                                      igraph_long_t eid, igraph_bool_t value);
DECLDIR igraph_error_t igraph_cattribute_EAS_set(igraph_t *graph, const char *name,
                                      igraph_long_t eid, const char *value);

DECLDIR igraph_error_t igraph_cattribute_VAN_setv(igraph_t *graph, const char *name,
                                       const igraph_vector_t *v);
DECLDIR igraph_error_t igraph_cattribute_VAB_setv(igraph_t *graph, const char *name,
                                       const igraph_vector_bool_t *v);
DECLDIR igraph_error_t igraph_cattribute_VAS_setv(igraph_t *graph, const char *name,
                                       const igraph_strvector_t *sv);
DECLDIR igraph_error_t igraph_cattribute_EAN_setv(igraph_t *graph, const char *name,
                                       const igraph_vector_t *v);
DECLDIR igraph_error_t igraph_cattribute_EAB_setv(igraph_t *graph, const char *name,
                                       const igraph_vector_bool_t *v);
DECLDIR igraph_error_t igraph_cattribute_EAS_setv(igraph_t *graph, const char *name,
                                       const igraph_strvector_t *sv);
