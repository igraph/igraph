...
IGRAPH_EXPORT igraph_error_t FUNCTION(igraph_matrix, init)(TYPE(igraph_matrix) *m,
...
IGRAPH_EXPORT igraph_error_t FUNCTION(igraph_matrix, get_row)(const TYPE(igraph_matrix) *m,
                                                   TYPE(igraph_vector) *res, long int index);
IGRAPH_EXPORT igraph_error_t FUNCTION(igraph_matrix, get_col)(const TYPE(igraph_matrix) *m,
                                                   TYPE(igraph_vector) *res, long int index);
IGRAPH_EXPORT igraph_error_t FUNCTION(igraph_matrix, set_row)(TYPE(igraph_matrix) *m,
                                                   const TYPE(igraph_vector) *v, long int index);
IGRAPH_EXPORT igraph_error_t FUNCTION(igraph_matrix, set_col)(TYPE(igraph_matrix) *m,
                                                   const TYPE(igraph_vector) *v, long int index);
IGRAPH_EXPORT igraph_error_t FUNCTION(igraph_matrix, select_rows)(const TYPE(igraph_matrix) *m,
                                                       TYPE(igraph_matrix) *res,
                                                       const igraph_vector_t *rows);
IGRAPH_EXPORT igraph_error_t FUNCTION(igraph_matrix, select_cols)(const TYPE(igraph_matrix) *m,
                                                       TYPE(igraph_matrix) *res,
                                                       const igraph_vector_t *cols);
IGRAPH_EXPORT igraph_error_t FUNCTION(igraph_matrix, select_rows_cols)(const TYPE(igraph_matrix) *m,
                                                            TYPE(igraph_matrix) *res,
                                                            const igraph_vector_t *rows,
                                                            const igraph_vector_t *cols);
...
IGRAPH_EXPORT igraph_error_t FUNCTION(igraph_matrix, swap_rows)(TYPE(igraph_matrix) *m,
                                                     long int i, long int j);
IGRAPH_EXPORT igraph_error_t FUNCTION(igraph_matrix, swap_cols)(TYPE(igraph_matrix) *m,
                                                     long int i, long int j);
IGRAPH_EXPORT igraph_error_t FUNCTION(igraph_matrix, swap_rowcol)(TYPE(igraph_matrix) *m,
                                                       long int i, long int j);
...
IGRAPH_EXPORT igraph_error_t FUNCTION(igraph_matrix, which_min)(const TYPE(igraph_matrix) *m,
                                                     long int *i, long int *j);
IGRAPH_EXPORT igraph_error_t FUNCTION(igraph_matrix, which_max)(const TYPE(igraph_matrix) *m,
                                                     long int *i, long int *j);
IGRAPH_EXPORT igraph_error_t FUNCTION(igraph_matrix, minmax)(const TYPE(igraph_matrix) *m,
                                                  BASE *min, BASE *max);
IGRAPH_EXPORT igraph_error_t FUNCTION(igraph_matrix, which_minmax)(const TYPE(igraph_matrix) *m,
...
IGRAPH_EXPORT igraph_error_t FUNCTION(igraph_matrix, resize)(TYPE(igraph_matrix) *m,
                                                  long int nrow, long int ncol);
IGRAPH_EXPORT igraph_error_t FUNCTION(igraph_matrix, resize_min)(TYPE(igraph_matrix) *m);
IGRAPH_EXPORT igraph_error_t FUNCTION(igraph_matrix, add_cols)(TYPE(igraph_matrix) *m, long int n);
IGRAPH_EXPORT igraph_error_t FUNCTION(igraph_matrix, add_rows)(TYPE(igraph_matrix) *m, long int n);
IGRAPH_EXPORT igraph_error_t FUNCTION(igraph_matrix, remove_col)(TYPE(igraph_matrix) *m, long int col);
IGRAPH_EXPORT igraph_error_t FUNCTION(igraph_matrix, remove_row)(TYPE(igraph_matrix) *m, long int row);
...
IGRAPH_EXPORT igraph_error_t FUNCTION(igraph_matrix, permdelete_rows)(TYPE(igraph_matrix) *m,
                                                           long int *index, long int nremove);
IGRAPH_EXPORT igraph_error_t FUNCTION(igraph_matrix, delete_rows_neg)(TYPE(igraph_matrix) *m,
