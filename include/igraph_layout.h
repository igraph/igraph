...
DECLDIR igraph_integer_t igraph_layout_random(const igraph_t *graph, igraph_matrix_t *res);
DECLDIR igraph_integer_t igraph_layout_circle(const igraph_t *graph, igraph_matrix_t *res,
                                 igraph_vs_t order);
DECLDIR igraph_integer_t igraph_layout_star(const igraph_t *graph, igraph_matrix_t *res,
                               igraph_integer_t center, const igraph_vector_t *order);
DECLDIR igraph_integer_t igraph_layout_grid(const igraph_t *graph, igraph_matrix_t *res, igraph_integer_t width);
DECLDIR igraph_integer_t igraph_layout_fruchterman_reingold(const igraph_t *graph,
        igraph_matrix_t *res,
...
DECLDIR igraph_integer_t igraph_layout_kamada_kawai(const igraph_t *graph, igraph_matrix_t *res,
...
DECLDIR igraph_integer_t igraph_layout_springs(const igraph_t *graph, igraph_matrix_t *res,
                                  igraph_real_t mass, igraph_real_t equil, igraph_real_t k,
                                  igraph_real_t repeqdis, igraph_real_t kfr, igraph_bool_t repulse);
DECLDIR igraph_integer_t igraph_layout_lgl(const igraph_t *graph, igraph_matrix_t *res,
...
DECLDIR igraph_integer_t igraph_layout_reingold_tilford(const igraph_t *graph, igraph_matrix_t *res,
        igraph_neimode_t mode,
        const igraph_vector_t *roots,
        const igraph_vector_t *rootlevel);
DECLDIR igraph_integer_t igraph_layout_reingold_tilford_circular(const igraph_t *graph,
        igraph_matrix_t *res,
        igraph_neimode_t mode,
        const igraph_vector_t *roots,
        const igraph_vector_t *rootlevel);
DECLDIR igraph_integer_t igraph_layout_sugiyama(const igraph_t *graph, igraph_matrix_t *res,
...
DECLDIR igraph_integer_t igraph_layout_random_3d(const igraph_t *graph, igraph_matrix_t *res);
DECLDIR igraph_integer_t igraph_layout_sphere(const igraph_t *graph, igraph_matrix_t *res);
DECLDIR igraph_integer_t igraph_layout_grid_3d(const igraph_t *graph, igraph_matrix_t *res,
                                  igraph_integer_t width, igraph_integer_t height);
DECLDIR igraph_integer_t igraph_layout_fruchterman_reingold_3d(const igraph_t *graph,
        igraph_matrix_t *res,
        igraph_bool_t use_seed,
        igraph_integer_t niter,
        igraph_real_t start_temp,
...
DECLDIR igraph_integer_t igraph_layout_kamada_kawai_3d(const igraph_t *graph, igraph_matrix_t *res,
        igraph_bool_t use_seed, igraph_integer_t maxiter,
        igraph_real_t epsilon, igraph_real_t kkconst,
        const igraph_vector_t *weights,
        const igraph_vector_t *minx, const igraph_vector_t *maxx,
...
DECLDIR igraph_integer_t igraph_layout_graphopt(const igraph_t *graph,
...
DECLDIR igraph_integer_t igraph_layout_mds(const igraph_t *graph, igraph_matrix_t *res,
                              const igraph_matrix_t *dist, igraph_integer_t dim);

DECLDIR igraph_integer_t igraph_layout_bipartite(const igraph_t *graph,
 ...
 * \member cooldown_damping_mult Damping fact igraph_integer_t the cooldown phase.
...
DECLDIR igraph_integer_t igraph_layout_drl_options_init(igraph_layout_drl_options_t *options,
        igraph_layout_drl_default_t templ);
DECLDIR igraph_integer_t igraph_layout_drl(const igraph_t *graph, igraph_matrix_t *res,
                              igraph_bool_t use_seed,
                              igraph_layout_drl_options_t *options,
                              const igraph_vector_t *weights,
                              const igraph_vector_bool_t *fixed);

DECLDIR igraph_integer_t igraph_layout_drl_3d(const igraph_t *graph, igraph_matrix_t *res,
                                 igraph_bool_t use_seed,
                                 igraph_layout_drl_options_t *options,
                                 const igraph_vector_t *weights,
                                 const igraph_vector_bool_t *fixed);

DECLDIR igraph_integer_t igraph_layout_merge_dla(igraph_vector_ptr_t *graphs,
                                    igraph_vector_ptr_t *coords,
                                    igraph_matrix_t *res);

DECLDIR igraph_integer_t igraph_layout_gem(const igraph_t *graph, igraph_matrix_t *res,
                              igraph_bool_t use_seed, igraph_integer_t maxiter,
                              igraph_real_t temp_max, igraph_real_t temp_min,
                              igraph_real_t temp_init);

DECLDIR igraph_integer_t igraph_layout_davidson_harel(const igraph_t *graph, igraph_matrix_t *res,
        igraph_bool_t use_seed, igraph_integer_t maxiter,
