 ...
 * by \a igraph during igraph_long_t calculations. A typical usage of the interruption
 ...
 * </para>
 * <para>
 * Your interruption handler will be called regularly during igraph_long_t operations
 ...
 * \a igraph functions. If the calculation is expected to take a igraph_long_t time
...
typedef igraph_long_t igraph_interruption_handler_t (void* data);
...
DECLDIR igraph_error_t igraph_allow_interruption(void* data);
