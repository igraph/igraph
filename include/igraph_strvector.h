...
IGRAPH_EXPORT igraph_error_t igraph_strvector_init(igraph_strvector_t *sv, long int len);
...
IGRAPH_EXPORT igraph_error_t igraph_strvector_set(igraph_strvector_t *sv, long int idx,
                                       const char *value);
IGRAPH_EXPORT igraph_error_t igraph_strvector_set2(igraph_strvector_t *sv, long int idx,
...
IGRAPH_EXPORT igraph_error_t igraph_strvector_copy(igraph_strvector_t *to,
                                        const igraph_strvector_t *from);
IGRAPH_EXPORT igraph_error_t igraph_strvector_append(igraph_strvector_t *to,
                                          const igraph_strvector_t *from);
IGRAPH_EXPORT igraph_error_t igraph_strvector_resize(igraph_strvector_t* v, long int newsize);
