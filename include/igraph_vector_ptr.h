...
DECLDIR igraph_error_t igraph_vector_ptr_init      (igraph_vector_ptr_t* v, igraph_long_t size);
DECLDIR igraph_error_t igraph_vector_ptr_init_copy (igraph_vector_ptr_t* v, void** data, igraph_long_t length);
...
DECLDIR igraph_error_t igraph_vector_ptr_reserve   (igraph_vector_ptr_t* v, igraph_long_t size);
DECLDIR igraph_bool_t igraph_vector_ptr_empty     (const igraph_vector_ptr_t* v);
DECLDIR igraph_error_t igraph_vector_ptr_size      (const igraph_vector_ptr_t* v);
DECLDIR void igraph_vector_ptr_clear     (igraph_vector_ptr_t* v);
DECLDIR void igraph_vector_ptr_null      (igraph_vector_ptr_t* v);
DECLDIR igraph_error_t igraph_vector_ptr_push_back (igraph_vector_ptr_t* v, void* e);
DECLDIR igraph_error_t igraph_vector_ptr_append    (igraph_vector_ptr_t *to,
        const igraph_vector_ptr_t *from);
DECLDIR void *igraph_vector_ptr_pop_back (igraph_vector_ptr_t *v);
DECLDIR igraph_error_t igraph_vector_ptr_insert(igraph_vector_ptr_t *v, igraph_long_t pos, void* e);
...
DECLDIR igraph_error_t igraph_vector_ptr_resize(igraph_vector_ptr_t* v, igraph_long_t newsize);
DECLDIR void igraph_vector_ptr_copy_to(const igraph_vector_ptr_t *v, void** to);
DECLDIR igraph_error_t igraph_vector_ptr_copy(igraph_vector_ptr_t *to, const igraph_vector_ptr_t *from);
...
DECLDIR igraph_error_t igraph_vector_ptr_index_int(igraph_vector_ptr_t *v,
