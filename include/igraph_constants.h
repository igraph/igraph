...
#define IGRAPH_REVERSE_MODE(mode)                                              \
  ((mode) == IGRAPH_IN ? IGRAPH_OUT                                            \
                       : ((mode) == IGRAPH_OUT ? IGRAPH_IN : (mode)))
...
typedef enum {
    IGRAPH_DEGSEQ_CONFIGURATION =
        0,            /* Configuration model, allowing non-simple graphs */
    ...
    IGRAPH_DEGSEQ_CONFIGURATION_SIMPLE,  /* Configuration model, generates simple
                                          graphs */
    IGRAPH_DEGSEQ_EDGE_SWITCHING_SIMPLE, /* Edge-switching MCMC, generates simple
                                          graphs */

    /* Deprecated, kept for backwards compatibility: */
    IGRAPH_DEGSEQ_SIMPLE IGRAPH_DEPRECATED_ENUMVAL = IGRAPH_DEGSEQ_CONFIGURATION,
    IGRAPH_DEGSEQ_SIMPLE_NO_MULTIPLE IGRAPH_DEPRECATED_ENUMVAL =
        IGRAPH_DEGSEQ_FAST_HEUR_SIMPLE,
    IGRAPH_DEGSEQ_SIMPLE_NO_MULTIPLE_UNIFORM IGRAPH_DEPRECATED_ENUMVAL =
...
typedef enum {
    IGRAPH_UNDIRECTED_CYCLE_SEARCH_BOTH = 0,
