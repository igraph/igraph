...
IGRAPH_EXPORT igraph_error_t igraph_diameter_bound(const igraph_t *graph, igraph_integer_t *res,
                                  igraph_integer_t start, igraph_integer_t *from,
                                  igraph_integer_t *to, igraph_bool_t directed,
