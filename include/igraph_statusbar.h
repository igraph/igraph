...
typedef igraph_integer_t igraph_status_handler_t(const char *message, void *data);
...
DECLDIR igraph_integer_t igraph_status(const char *message, void *data);
...
DECLDIR igraph_integer_t igraph_statusf(const char *message, void *data, ...);
