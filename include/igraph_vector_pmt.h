...
DECLDIR igraph_long_t FUNCTION(igraph_vector, init)(TYPE(igraph_vector)* v, igraph_long_t size);
DECLDIR igraph_long_t FUNCTION(igraph_vector, init_copy)(TYPE(igraph_vector)* v,
        const BASE* data, igraph_long_t length);
DECLDIR igraph_long_t FUNCTION(igraph_vector, init_seq)(TYPE(igraph_vector)*v, BASE from, BASE to);
DECLDIR igraph_long_t FUNCTION(igraph_vector, copy)(TYPE(igraph_vector) *to,
        const TYPE(igraph_vector) *from);
DECLDIR void FUNCTION(igraph_vector, destroy)(TYPE(igraph_vector)* v);

DECLDIR igraph_long_t FUNCTION(igraph_vector, capacity)(const TYPE(igraph_vector)*v);
...
DECLDIR igraph_long_t FUNCTION(igraph_vector, update)(TYPE(igraph_vector) *to,
        const TYPE(igraph_vector) *from);
DECLDIR igraph_long_t FUNCTION(igraph_vector, append)(TYPE(igraph_vector) *to,
        const TYPE(igraph_vector) *from);
DECLDIR igraph_long_t FUNCTION(igraph_vector, swap)(TYPE(igraph_vector) *v1, TYPE(igraph_vector) *v2);

/*-----------------------*/
/* Exchanging elements   */
/*-----------------------*/

DECLDIR igraph_long_t FUNCTION(igraph_vector, swap_elements)(TYPE(igraph_vector) *v,
        igraph_long_t i, igraph_long_t j);
DECLDIR igraph_long_t FUNCTION(igraph_vector, reverse)(TYPE(igraph_vector) *v);
DECLDIR igraph_long_t FUNCTION(igraph_vector, shuffle)(TYPE(igraph_vector) *v);
...
DECLDIR igraph_long_t FUNCTION(igraph_vector, add)(TYPE(igraph_vector) *v1,
        const TYPE(igraph_vector) *v2);
DECLDIR igraph_long_t FUNCTION(igraph_vector, sub)(TYPE(igraph_vector) *v1,
        const TYPE(igraph_vector) *v2);
DECLDIR igraph_long_t FUNCTION(igraph_vector, mul)(TYPE(igraph_vector) *v1,
        const TYPE(igraph_vector) *v2);
DECLDIR igraph_long_t FUNCTION(igraph_vector, div)(TYPE(igraph_vector) *v1,
        const TYPE(igraph_vector) *v2);
DECLDIR igraph_long_t FUNCTION(igraph_vector, cumsum)(TYPE(igraph_vector) *to,
        const TYPE(igraph_vector) *from);

#ifndef NOABS
    DECLDIR igraph_long_t FUNCTION(igraph_vector, abs)(TYPE(igraph_vector) *v);
#endif
...
DECLDIR igraph_long_t FUNCTION(igraph_vector, which_min)(const TYPE(igraph_vector)* v);
DECLDIR igraph_long_t FUNCTION(igraph_vector, which_max)(const TYPE(igraph_vector)* v);
DECLDIR igraph_long_t FUNCTION(igraph_vector, minmax)(const TYPE(igraph_vector) *v,
        BASE *min, BASE *max);
DECLDIR igraph_long_t FUNCTION(igraph_vector, which_minmax)(const TYPE(igraph_vector) *v,
...
DECLDIR igraph_long_t FUNCTION(igraph_vector, resize)(TYPE(igraph_vector)* v, igraph_long_t newsize);
DECLDIR igraph_long_t FUNCTION(igraph_vector, resize_min)(TYPE(igraph_vector)*v);
DECLDIR igraph_long_t FUNCTION(igraph_vector, reserve)(TYPE(igraph_vector)* v, igraph_long_t size);
DECLDIR igraph_long_t FUNCTION(igraph_vector, push_back)(TYPE(igraph_vector)* v, BASE e);
DECLDIR BASE FUNCTION(igraph_vector, pop_back)(TYPE(igraph_vector)* v);
DECLDIR igraph_long_t FUNCTION(igraph_vector, insert)(TYPE(igraph_vector) *v, igraph_long_t pos, BASE value);
...
DECLDIR igraph_long_t FUNCTION(igraph_vector, qsort_ind)(TYPE(igraph_vector) *v,
...
DECLDIR igraph_long_t FUNCTION(igraph_vector, print)(const TYPE(igraph_vector) *v);
DECLDIR igraph_long_t FUNCTION(igraph_vector, printf)(const TYPE(igraph_vector) *v,
                                    const char *format);
DECLDIR igraph_long_t FUNCTION(igraph_vector, fprint)(const TYPE(igraph_vector) *v, FILE *file);

#ifdef BASE_COMPLEX

DECLDIR igraph_long_t igraph_vector_complex_real(const igraph_vector_complex_t *v,
                                       igraph_vector_t *real);
DECLDIR igraph_long_t igraph_vector_complex_imag(const igraph_vector_complex_t *v,
                                       igraph_vector_t *imag);
DECLDIR igraph_long_t igraph_vector_complex_realimag(const igraph_vector_complex_t *v,
        igraph_vector_t *real,
        igraph_vector_t *imag);
DECLDIR igraph_long_t igraph_vector_complex_create(igraph_vector_complex_t *v,
        const igraph_vector_t *real,
        const igraph_vector_t *imag);
DECLDIR igraph_long_t igraph_vector_complex_create_polar(igraph_vector_complex_t *v,
        const igraph_vector_t *r,
        const igraph_vector_t *theta);

#endif

DECLDIR igraph_long_t FUNCTION(igraph_vector, init_real)(TYPE(igraph_vector)*v, igraph_long_t no, ...);
DECLDIR igraph_long_t FUNCTION(igraph_vector, init_int)(TYPE(igraph_vector)*v, igraph_long_t no, ...);
DECLDIR igraph_long_t FUNCTION(igraph_vector, init_real_end)(TYPE(igraph_vector)*v, double endmark, ...);
DECLDIR igraph_long_t FUNCTION(igraph_vector, init_int_end)(TYPE(igraph_vector)*v, igraph_long_t endmark, ...);

DECLDIR igraph_long_t FUNCTION(igraph_vector, move_interval)(TYPE(igraph_vector) *v,
        igraph_long_t begin, igraph_long_t end, igraph_long_t to);
DECLDIR igraph_long_t FUNCTION(igraph_vector, move_interval2)(TYPE(igraph_vector) *v,
        igraph_long_t begin, igraph_long_t end, igraph_long_t to);
DECLDIR void FUNCTION(igraph_vector, permdelete)(TYPE(igraph_vector) *v,
        const igraph_vector_t *index,
        igraph_long_t nremove);
DECLDIR igraph_long_t FUNCTION(igraph_vector, filter_smaller)(TYPE(igraph_vector) *v, BASE elem);
DECLDIR igraph_long_t FUNCTION(igraph_vector, get_interval)(const TYPE(igraph_vector) *v,
        TYPE(igraph_vector) *res,
        igraph_long_t from, igraph_long_t to);
DECLDIR igraph_long_t FUNCTION(igraph_vector, difference_sorted)(const TYPE(igraph_vector) *v1,
        const TYPE(igraph_vector) *v2, TYPE(igraph_vector) *result);
DECLDIR igraph_long_t FUNCTION(igraph_vector, intersect_sorted)(const TYPE(igraph_vector) *v1,
        const TYPE(igraph_vector) *v2, TYPE(igraph_vector) *result);

DECLDIR igraph_long_t FUNCTION(igraph_vector, index)(const TYPE(igraph_vector) *v,
                                   TYPE(igraph_vector) *newv,
                                   const igraph_vector_t *idx);

DECLDIR igraph_long_t FUNCTION(igraph_vector, index_int)(TYPE(igraph_vector) *v,
