...
IGRAPH_EXPORT igraph_error_t igraph_spmatrix_init(igraph_spmatrix_t *m, long int nrow, long int ncol);
...
IGRAPH_EXPORT igraph_error_t igraph_spmatrix_set(igraph_spmatrix_t *m, long int row, long int col,
                                      igraph_real_t value);
IGRAPH_EXPORT igraph_error_t igraph_spmatrix_add_e(igraph_spmatrix_t *m, long int row, long int col,
                                        igraph_real_t value);
IGRAPH_EXPORT igraph_error_t igraph_spmatrix_add_col_values(igraph_spmatrix_t *m, long int to, long int from);
...
IGRAPH_EXPORT igraph_error_t igraph_spmatrix_copy_to(const igraph_spmatrix_t *m, igraph_real_t *to);
IGRAPH_EXPORT igraph_error_t igraph_spmatrix_null(igraph_spmatrix_t *m);
IGRAPH_EXPORT igraph_error_t igraph_spmatrix_add_cols(igraph_spmatrix_t *m, long int n);
IGRAPH_EXPORT igraph_error_t igraph_spmatrix_add_rows(igraph_spmatrix_t *m, long int n);
IGRAPH_EXPORT igraph_error_t igraph_spmatrix_clear_col(igraph_spmatrix_t *m, long int col);
IGRAPH_EXPORT igraph_error_t igraph_spmatrix_clear_row(igraph_spmatrix_t *m, long int row);
IGRAPH_EXPORT igraph_error_t igraph_spmatrix_copy(igraph_spmatrix_t *to, const igraph_spmatrix_t *from);
...
IGRAPH_EXPORT igraph_error_t igraph_spmatrix_colsums(const igraph_spmatrix_t *m, igraph_vector_t *res);
IGRAPH_EXPORT igraph_error_t igraph_spmatrix_rowsums(const igraph_spmatrix_t *m, igraph_vector_t *res);

IGRAPH_EXPORT igraph_error_t igraph_spmatrix_print(const igraph_spmatrix_t *matrix);
IGRAPH_EXPORT igraph_error_t igraph_spmatrix_fprint(const igraph_spmatrix_t *matrix, FILE* file);
...
IGRAPH_EXPORT igraph_error_t igraph_spmatrix_iter_create(igraph_spmatrix_iter_t *mit, const igraph_spmatrix_t *m);
IGRAPH_EXPORT igraph_error_t igraph_spmatrix_iter_reset(igraph_spmatrix_iter_t *mit);
IGRAPH_EXPORT igraph_error_t igraph_spmatrix_iter_next(igraph_spmatrix_iter_t *mit);
