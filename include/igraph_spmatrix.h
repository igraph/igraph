...
IGRAPH_EXPORT IGRAPH_DEPRECATED long int igraph_spmatrix_size(const igraph_spmatrix_t *m);
IGRAPH_EXPORT IGRAPH_DEPRECATED long int igraph_spmatrix_nrow(const igraph_spmatrix_t *m);
IGRAPH_EXPORT IGRAPH_DEPRECATED long int igraph_spmatrix_ncol(const igraph_spmatrix_t *m);
...
IGRAPH_EXPORT IGRAPH_DEPRECATED igraph_error_t igraph_spmatrix_add_cols(igraph_spmatrix_t *m, long int n);
IGRAPH_EXPORT IGRAPH_DEPRECATED igraph_error_t igraph_spmatrix_add_rows(igraph_spmatrix_t *m, long int n);
IGRAPH_EXPORT IGRAPH_DEPRECATED igraph_error_t igraph_spmatrix_clear_col(igraph_spmatrix_t *m, long int col);
IGRAPH_EXPORT IGRAPH_DEPRECATED igraph_error_t igraph_spmatrix_clear_row(igraph_spmatrix_t *m, long int row);
IGRAPH_EXPORT IGRAPH_DEPRECATED igraph_error_t igraph_spmatrix_copy(igraph_spmatrix_t *to, const igraph_spmatrix_t *from);
IGRAPH_EXPORT IGRAPH_DEPRECATED igraph_real_t igraph_spmatrix_max_nonzero(const igraph_spmatrix_t *m,
                                                        igraph_real_t *ridx, igraph_real_t *cidx);
IGRAPH_EXPORT IGRAPH_DEPRECATED igraph_real_t igraph_spmatrix_max(const igraph_spmatrix_t *m,
                                                igraph_real_t *ridx, igraph_real_t *cidx);
IGRAPH_EXPORT IGRAPH_DEPRECATED void igraph_spmatrix_scale(igraph_spmatrix_t *m, igraph_real_t by);
IGRAPH_EXPORT IGRAPH_DEPRECATED igraph_error_t igraph_spmatrix_colsums(const igraph_spmatrix_t *m, igraph_vector_t *res);
IGRAPH_EXPORT IGRAPH_DEPRECATED igraph_error_t igraph_spmatrix_rowsums(const igraph_spmatrix_t *m, igraph_vector_t *res);

IGRAPH_EXPORT IGRAPH_DEPRECATED igraph_error_t igraph_spmatrix_print(const igraph_spmatrix_t *matrix);
IGRAPH_EXPORT IGRAPH_DEPRECATED igraph_error_t igraph_spmatrix_fprint(const igraph_spmatrix_t *matrix, FILE* file);
...
IGRAPH_EXPORT IGRAPH_DEPRECATED igraph_error_t igraph_spmatrix_iter_create(igraph_spmatrix_iter_t *mit, const igraph_spmatrix_t *m);
IGRAPH_EXPORT IGRAPH_DEPRECATED igraph_error_t igraph_spmatrix_iter_reset(igraph_spmatrix_iter_t *mit);
IGRAPH_EXPORT IGRAPH_DEPRECATED igraph_error_t igraph_spmatrix_iter_next(igraph_spmatrix_iter_t *mit);
IGRAPH_EXPORT IGRAPH_DEPRECATED igraph_bool_t igraph_spmatrix_iter_end(igraph_spmatrix_iter_t *mit);
IGRAPH_EXPORT IGRAPH_DEPRECATED void igraph_spmatrix_iter_destroy(igraph_spmatrix_iter_t *mit);
