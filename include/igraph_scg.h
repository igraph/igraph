...
DECLDIR igraph_long_t igraph_scg_grouping(const igraph_matrix_t *V,
...
DECLDIR igraph_long_t igraph_scg_semiprojectors(const igraph_vector_t *groups,
                                      igraph_scg_matrix_t mtype,
                                      igraph_matrix_t *L,
                                      igraph_matrix_t *R,
...
DECLDIR igraph_long_t igraph_scg_norm_eps(const igraph_matrix_t *V,
...
DECLDIR igraph_long_t igraph_scg_adjacency(const igraph_t *graph,
...
DECLDIR igraph_long_t igraph_scg_stochastic(const igraph_t *graph,
                                  const igraph_matrix_t *matrix,
                                  const igraph_sparsemat_t *sparsemat,
                                  const igraph_vector_t *ev,
                                  igraph_long_t nt,
...
DECLDIR igraph_long_t igraph_scg_laplacian(const igraph_t *graph,
                                 const igraph_matrix_t *matrix,
                                 const igraph_sparsemat_t *sparsemat,
                                 const igraph_vector_t *ev,
                                 igraph_long_t nt,
