...
IGRAPH_EXPORT igraph_error_t igraph_bond_percolation(const igraph_t *graph, igraph_vector_int_t *output, igraph_vector_int_t *edge_indices);
IGRAPH_EXPORT igraph_error_t igraph_site_percolation(const igraph_t *graph, igraph_vector_int_t *output, igraph_vector_int_t *vertices);
