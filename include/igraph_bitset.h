...
IGRAPH_EXPORT igraph_integer_t igraph_bitset_capacity(const igraph_bitset_t *bitset);
IGRAPH_EXPORT igraph_integer_t igraph_bitset_size(const igraph_bitset_t *bitset);
...
IGRAPH_EXPORT igraph_integer_t igraph_bitset_popcount(const igraph_bitset_t *bitset);
IGRAPH_EXPORT igraph_integer_t igraph_bitset_countl_zero(const igraph_bitset_t *bitset);
IGRAPH_EXPORT igraph_integer_t igraph_bitset_countl_one(const igraph_bitset_t *bitset);
IGRAPH_EXPORT igraph_integer_t igraph_bitset_countr_zero(const igraph_bitset_t *bitset);
IGRAPH_EXPORT igraph_integer_t igraph_bitset_countr_one(const igraph_bitset_t *bitset);
