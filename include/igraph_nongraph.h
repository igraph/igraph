...
DECLDIR igraph_integer_t igraph_running_mean(const igraph_vector_t *data, igraph_vector_t *res,
                                igraph_integer_t binwidth);
DECLDIR igraph_integer_t igraph_random_sample(igraph_vector_t *res, igraph_real_t l, igraph_real_t h,
                                 igraph_integer_t length);
DECLDIR igraph_integer_t igraph_convex_hull(const igraph_matrix_t *data, igraph_vector_t *resverts,
                               igraph_matrix_t *rescoords);
DECLDIR igraph_integer_t igraph_zeroin(igraph_real_t *ax, igraph_real_t *bx,
                          igraph_real_t (*f)(igraph_real_t x, void *info),
                          void *info, igraph_real_t *Tol, igraph_integer_t *Maxit, igraph_real_t *res);
DECLDIR igraph_integer_t igraph_bfgs(igraph_vector_t *b, igraph_real_t *Fmin,
...
DECLDIR igraph_integer_t igraph_power_law_fit(const igraph_vector_t* vector, igraph_plfit_result_t* result,
