...
DECLDIR igraph_error_t igraph_adjacency_spectral_embedding(const igraph_t *graph,
        igraph_long_t no,
...
DECLDIR igraph_error_t igraph_laplacian_spectral_embedding(const igraph_t *graph,
        igraph_long_t no,
        const igraph_vector_t *weights,
        igraph_eigen_which_position_t which,
...
DECLDIR igraph_error_t igraph_dim_select(const igraph_vector_t *sv, igraph_long_t *dim);
