...
### Added
 ...
 - `igraph_simple_cycles()` and `igraph_simple_cycles_callback()` find all simple cycles in a graph, optionally with an upper bound on the cycle length. Many thanks to Tim Bernhard @GenieTim for contributing this functionality in #2181.
