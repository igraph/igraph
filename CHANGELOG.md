...
### Added
 ...
 - `igraph_get_widest_path()`, `igraph_get_widest_paths()`, `igraph_igraph_widest_path_widths_dijkstra()` and `igraph_igraph_widest_path_widths_floyd_warshall()` to find widest paths (#1893, thanks to @Gomango999).
