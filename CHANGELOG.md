...
### Changed
 ...
 - The implementation of the Infomap algorithm behind `igraph_community_infomap()` has been updated with a more recent version (2.8.0), while keeping the API compatible with previous igraph versions.
