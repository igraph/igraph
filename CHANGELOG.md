...
### Added
 ...
 - `igraph_get_widest_path()`, `igraph_get_widest_paths()`, `igraph_widest_path_lengths_dijkstra()` and `igraph_widest_path_lengths_floyd_warshall()` to find widest paths (#1893, thanks to @Gomango999).
