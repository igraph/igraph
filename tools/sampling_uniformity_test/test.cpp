...
int main() {
    ...
    const igraph_edge_type_sw_t allowed_edge_types = IGRAPH_LOOPS_SW | IGRAPH_MULTI_SW;
    ...
    for (int iter = 0; iter < samples; iter++) {
        ...
        igraph_erdos_renyi_game_gnm(&g, N, M, directed, allowed_edge_types, false); // unipartite
