...
igraph_long_t check_convex_hull(igraph_matrix_t* coords) {
    ...
    for (i = 0; i < igraph_vector_size(&result); i++) {
        printf("%ld ", (igraph_long_t)VECTOR(result)[i]);
    }
    printf("\n");
...
igraph_long_t test_simple() {
    igraph_real_t coords_array[][2] = {
        {3, 2}, {5, 1}, {4, 4}, {6, 4}, {4, 3},
        {2, 5}, {1, 3}, {2, 4}, {6, 3}, {9, 2}
    };
    igraph_matrix_t coords;
    igraph_long_t i, result;
