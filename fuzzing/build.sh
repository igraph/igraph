...
cd $SRC
wget https://download.gnome.org/sources/libxml2/2.11/libxml2-2.11.4.tar.xz
tar xf libxml2-2.11.4.tar.xz
cd libxml2-2.11.4
...
for TARGET in read_gml_fuzzer read_pajek_fuzzer read_dl_fuzzer read_lgl_fuzzer read_ncol_fuzzer read_graphml_fuzzer read_edgelist_fuzzer read_graphdb_fuzzer bliss_fuzzer edge_connectivity_fuzzer vertex_separators_fuzzer
do
