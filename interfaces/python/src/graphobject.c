...
struct PyMethodDef igraphmodule_Graph_methods[] = {
  ...
  {"feedback_arc_set", (PyCFunction) igraphmodule_Graph_feedback_arc_set,
   ...
   "  set.\n"
   "@param method: the algorithm to use. C{\"eades\"} uses the greedy cycle breaking\n"
   ...
   "  to be removed is smaller than |E|/2 - |V|/6. C{\"ip\"} uses an integer\n"
  ...
  {"count_subisomorphisms_vf2",
   ...
   "  edge_color1=None, edge_color2=None)\n\n"
