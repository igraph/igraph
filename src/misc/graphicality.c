...
static igraph_long_t igraph_i_is_graphical_undirected_multi_loops(const igraph_vector_t *degrees, igraph_bool_t *res);
static igraph_long_t igraph_i_is_graphical_undirected_loopless_multi(const igraph_vector_t *degrees, igraph_bool_t *res);
static igraph_long_t igraph_i_is_graphical_undirected_loopy_simple(const igraph_vector_t *degrees, igraph_bool_t *res);
static igraph_long_t igraph_i_is_graphical_undirected_simple(const igraph_vector_t *degrees, igraph_bool_t *res);

static igraph_long_t igraph_i_is_graphical_directed_loopy_multi(const igraph_vector_t *out_degrees, const igraph_vector_t *in_degrees, igraph_bool_t *res);
static igraph_long_t igraph_i_is_graphical_directed_loopless_multi(const igraph_vector_t *out_degrees, const igraph_vector_t *in_degrees, igraph_bool_t *res);
static igraph_long_t igraph_i_is_graphical_directed_loopy_simple(const igraph_vector_t *out_degrees, const igraph_vector_t *in_degrees, igraph_bool_t *res);
static igraph_long_t igraph_i_is_graphical_directed_simple(const igraph_vector_t *out_degrees, const igraph_vector_t *in_degrees, igraph_bool_t *res);

static igraph_long_t igraph_i_is_bigraphical_multi(const igraph_vector_t *degrees1, const igraph_vector_t *degrees2, igraph_bool_t *res);
static igraph_long_t igraph_i_is_bigraphical_simple(const igraph_vector_t *degrees1, const igraph_vector_t *degrees2, igraph_bool_t *res);
 ...
 */
static igraph_long_t igraph_i_is_graphical_undirected_multi_loops(const igraph_vector_t *degrees, igraph_bool_t *res) {
    igraph_long_t sum_parity = 0; /* 0 if the degree sum is even, 1 if it is odd */
    igraph_long_t n = igraph_vector_size(degrees);
    igraph_long_t i;

    for (i=0; i < n; ++i) {
        igraph_long_t d = VECTOR(*degrees)[i];
 ...
 */
static igraph_long_t igraph_i_is_graphical_undirected_simple(const igraph_vector_t *degrees, igraph_bool_t *res) {
    igraph_vector_long_t num_degs; /* num_degs[d] is the # of vertices with degree d */
    const igraph_long_t p = igraph_vector_size(degrees);
    igraph_long_t dmin, dmax, dsum;
    igraph_long_t n; /* number of non-zero degrees */
    igraph_long_t k, sum_deg, sum_ni, sum_ini;
    igraph_long_t i, dk;
    igraph_long_t zverovich_bound;
...
finish:
    igraph_vector_long_destroy(&num_degs);
    IGRAPH_FINALLY_CLEAN(1);
 ...
 */
static igraph_long_t igraph_i_is_graphical_directed_loopy_multi(const igraph_vector_t *out_degrees, const igraph_vector_t *in_degrees, igraph_bool_t *res) {
    igraph_long_t sumdiff; /* difference between sum of in- and out-degrees */
    igraph_long_t n = igraph_vector_size(out_degrees);
    igraph_long_t i;
    ...
    sumdiff = 0;
    for (i=0; i < n; ++i) {
        igraph_long_t dout = VECTOR(*out_degrees)[i];
        igraph_long_t din  = VECTOR(*in_degrees)[i];
 ...
 */
static igraph_long_t igraph_i_is_graphical_directed_loopless_multi(const igraph_vector_t *out_degrees, const igraph_vector_t *in_degrees, igraph_bool_t *res) {
    igraph_long_t i, sumin, sumout, dmax;
    igraph_long_t n = igraph_vector_size(out_degrees);
...
static igraph_long_t igraph_i_qsort_dual_vector_cmp_desc(void* data, const void *p1, const void *p2) {
    ...
    igraph_long_t index2 = *((igraph_long_t*)p2);
...
static igraph_long_t igraph_i_is_graphical_directed_simple(const igraph_vector_t *out_degrees, const igraph_vector_t *in_degrees, igraph_bool_t *res) {
    ...
    igraph_long_t i, j, vcount, lhs, rhs;
    igraph_i_qsort_dual_vector_cmp_data_t sort_data;
    ...
    igraph_qsort_r(VECTOR(index_array), vcount, sizeof(igraph_long_t), &sort_data,
...
static igraph_long_t igraph_i_is_bigraphical_multi(const igraph_vector_t *degrees1, const igraph_vector_t *degrees2, igraph_bool_t *res) {
    igraph_long_t i;
    igraph_long_t sum1, sum2;
    igraph_long_t n1 = igraph_vector_size(degrees1), n2 = igraph_vector_size(degrees2);

    sum1 = 0;
    for (i=0; i < n1; ++i) {
        igraph_long_t d = VECTOR(*degrees1)[i];
    ...
    sum2 = 0;
    for (i=0; i < n2; ++i) {
        igraph_long_t d = VECTOR(*degrees2)[i];
...
static igraph_long_t igraph_i_is_bigraphical_simple(const igraph_vector_t *degrees1, const igraph_vector_t *degrees2, igraph_bool_t *res) {
    ...
    igraph_long_t n1 = igraph_vector_size(degrees1), n2 = igraph_vector_size(degrees2);
    igraph_long_t i, k;
    igraph_long_t lhs_sum, partial_rhs_sum;
...
igraph_long_t igraph_is_degree_sequence(const igraph_vector_t *out_degrees,
    ...
    if (in_degrees == 0) {
        ...
        if (((igraph_long_t)igraph_vector_sum(out_degrees) % 2) != 0) {
            FAIL;
        }
    } else {
