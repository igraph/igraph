...
igraph_int_t igraph_lapack_dgetrf(igraph_matrix_t *a, igraph_vector_int_t *ipiv,
                         igraph_int_t *info) {
    igraph_int_t m = (igraph_int_t) igraph_matrix_nrow(a);
    igraph_int_t n = (igraph_int_t) igraph_matrix_ncol(a);
    igraph_int_t lda = m > 0 ? m : 1;
...
igraph_int_t igraph_lapack_dgetrs(igraph_bool_t transpose, const igraph_matrix_t *a,
                         igraph_vector_int_t *ipiv, igraph_matrix_t *b) {
    char trans = transpose ? 'T' : 'N';
    igraph_int_t n = (igraph_int_t) igraph_matrix_nrow(a);
    igraph_int_t nrhs = (igraph_int_t) igraph_matrix_ncol(b);
    igraph_int_t lda = n > 0 ? n : 1;
    igraph_int_t ldb = n > 0 ? n : 1;
    igraph_int_t info;
...
igraph_int_t igraph_lapack_dgesv(igraph_matrix_t *a, igraph_vector_int_t *ipiv,
...
igraph_int_t igraph_lapack_dsyevr(const igraph_matrix_t *A,
    ...
    igraph_int_t n = (igraph_int_t) igraph_matrix_nrow(A), lda = n, ldz = n;
    igraph_int_t m, info;
    ...
    lwork = (igraph_int_t) VECTOR(work)[0];
...
igraph_int_t igraph_lapack_dgeev(const igraph_matrix_t *A,
    ...
    igraph_int_t n = (igraph_int_t) igraph_matrix_nrow(A);
    igraph_int_t lda = n, ldvl = n, ldvr = n, lwork = -1;
    igraph_vector_t work;
    igraph_vector_t *myreal = valuesreal, *myimag = valuesimag, vreal, vimag;
    igraph_matrix_t Acopy;
    igraph_int_t error = *info;
...
igraph_int_t igraph_lapack_dgeevx(igraph_lapack_dgeevx_balance_t balance,
...
igraph_int_t igraph_lapack_dgehrd(const igraph_matrix_t *A,
                         igraph_int_t ilo, igraph_int_t ihi,
                         igraph_matrix_t *result) {

    igraph_int_t n = (igraph_int_t) igraph_matrix_nrow(A);
    igraph_int_t lda = n;
    igraph_int_t lwork = -1;
    igraph_vector_t work;
