 ...
 */
igraph_long_t igraph_layout_grid(const igraph_t *graph, igraph_matrix_t *res, igraph_long_t width) {
    ...
    if (width <= 0) {
        width = (igraph_long_t) ceil(sqrt(no_of_nodes));
    }
 ...
 * Time complexity: O(|V|), the number of vertices.
 */
igraph_long_t igraph_layout_grid_3d(const igraph_t *graph, igraph_matrix_t *res,
    ...
    if (width <= 0 && height <= 0) {
        width = height = (igraph_long_t) ceil(pow(no_of_nodes, 1.0 / 3));
    } else if (width <= 0) {
        width = (igraph_long_t) ceil(sqrt(no_of_nodes / (double)height));
    } else if (height <= 0) {
        height = (igraph_long_t) ceil(sqrt(no_of_nodes / (double)width));
    }
