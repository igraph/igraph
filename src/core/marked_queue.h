...
IGRAPH_PRIVATE_EXPORT igraph_error_t igraph_marked_queue_init(igraph_marked_queue_t *q,
                                                              igraph_integer_t size);
...
IGRAPH_PRIVATE_EXPORT igraph_integer_t igraph_marked_queue_size(const igraph_marked_queue_t *q);

IGRAPH_PRIVATE_EXPORT igraph_error_t igraph_marked_queue_print(const igraph_marked_queue_t *q);
IGRAPH_PRIVATE_EXPORT igraph_error_t igraph_marked_queue_fprint(const igraph_marked_queue_t *q, FILE *file);

IGRAPH_PRIVATE_EXPORT igraph_bool_t igraph_marked_queue_iselement(const igraph_marked_queue_t *q,
                                                                  igraph_integer_t elem);
IGRAPH_PRIVATE_EXPORT igraph_error_t igraph_marked_queue_push(igraph_marked_queue_t *q, igraph_integer_t elem);

IGRAPH_PRIVATE_EXPORT igraph_error_t igraph_marked_queue_start_batch(igraph_marked_queue_t *q);
IGRAPH_PRIVATE_EXPORT void igraph_marked_queue_pop_back_batch(igraph_marked_queue_t *q);

IGRAPH_PRIVATE_EXPORT igraph_error_t igraph_marked_queue_as_vector(const igraph_marked_queue_t *q,
                                                                   igraph_vector_t *vec);
