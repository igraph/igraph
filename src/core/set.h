...
IGRAPH_PRIVATE_EXPORT igraph_error_t igraph_set_remove(igraph_set_t *set, igraph_integer_t e);
IGRAPH_PRIVATE_EXPORT igraph_error_t igraph_set_difference(igraph_set_t *set, igraph_set_t *to_remove);
