...
IGRAPH_PRIVATE_EXPORT igraph_error_t igraph_set_init(igraph_set_t* set, long int size);
...
IGRAPH_PRIVATE_EXPORT igraph_error_t igraph_set_reserve(igraph_set_t* set, long int size);
