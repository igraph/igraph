...
igraph_integer_t igraph_status(const char *message, void *data) {
...
igraph_integer_t igraph_statusf(const char *message, void *data, ...) {
    char buffer[300];
    va_list ap;
    va_start(ap, data);
...
igraph_integer_t igraph_status_handler_stderr(const char *message, void *data) {
    IGRAPH_UNUSED(data);
