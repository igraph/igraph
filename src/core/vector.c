                                            ...
                                            const igraph_vector_t *imag)
{
    ...
    {
        VECTOR(*v)
        [i] = igraph_complex(VECTOR(*real)[i], VECTOR(*imag)[i]);
    }
                                                  ...
                                                  const igraph_vector_t *theta)
{
    ...
    {
        VECTOR(*v)
        [i] = igraph_complex_polar(VECTOR(*r)[i], VECTOR(*theta)[i]);
    }
