/* ivout.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int igraphivout_(lout, n, ix, idigit, ifmt, ifmt_len)
integer *lout, *n, *ix, *idigit;
char *ifmt;
ftnlen ifmt_len;
{
    /* Format strings */
...
/*     integer i_len(), s_wsfe(), do_fio(), e_wsfe(); */
    ...
    /* Local variables */
    static char line[80];
    static integer i__, k1, k2, ndigit, lll;
