...
c-----------------------------------------------------------------------
c
      subroutine IGRAPHARPACKDNCONV (n, ritzr, ritzi, bounds, tol, nconv)
c
c     %----------------------------------------------------%
...
c
      Double precision
     &           IGRAPHARPACKDLAPY2, IGRAPHARPACKDLAMCH
      external   IGRAPHARPACKDLAPY2, IGRAPHARPACKDLAMCH
...
c
      nconv  = 0
      do 20 i = 1, n
         temp = max( eps23, IGRAPHARPACKDLAPY2( ritzr(i), ritzi(i) ) )
