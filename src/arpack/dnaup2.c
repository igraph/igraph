/* igraphdnaup2.f -- translated by f2c (version 19991025).
...
/*          listed in the same order as returned from igraphdneigh. */
...
/*     igraphdneigh  ARPACK compute Ritz values and error bounds routine. */
/*     igraphdngets  ARPACK reorder Ritz values and error bounds routine. */
/*     igraphdsortc  ARPACK sorting routine. */
...
/* Subroutine */ int igraphdnaup2_(ido, bmat, n, which, nev, np, tol, resid, mode, 
	iupd, ishift, mxiter, v, ldv, h__, ldh, ritzr, ritzi, bounds, q, ldq, 
	workl, ipntr, workd, info, bmat_len, which_len)
integer *ido;
char *bmat;
integer *n;
char *which;
...
ftnlen which_len;
{
    ...
    extern /* Subroutine */ int igraphdmout_();
    ...
    static integer kp[4];
    extern /* Subroutine */ int igraphdneigh_();
    static integer nevbef;
    extern /* Subroutine */ int igraphsecond_();
    static logical update;
    static char wprime[2];
    static logical ushift;
    static integer kplusp, msglvl, np0, nptemp, numcnv;
    extern /* Subroutine */ int igraphdnaitr_(), igraphdnconv_(), igraphdngets_(), igraphdnapps_(), 
	    igraphdsortc_();
    static integer nev0;
...
/*        | bounds obtained from igraphdneigh.                       | */
/*        %----------------------------------------------------% */
...
/*        | NOTE: The last two arguments of igraphdngets are no     | */
...
/*           %----------------------------------------------% */
/*           | To be consistent with igraphdngets, we first do a  | */
/*           | pre-processing sort in order to keep complex | */
/*           | conjugate pairs together.  This is similar   | */
/*           | to the pre-processing sort used in igraphdngets    | */
