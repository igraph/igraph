...
c-----------------------------------------------------------------------
c
      subroutine IGRAPHARPACKDSORTC (which, apply, n, xreal, ximag, y)
c
c     %------------------%
c     | Scalar Arguments |
c     %------------------%
...
c
            if (j.lt.0) go to 30
c
            temp1 = IGRAPHARPACKDLAPY2(xreal(j),ximag(j))
            temp2 = IGRAPHARPACKDLAPY2(xreal(j+igap),ximag(j+igap))
c
