/* dmout.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int igraphdmout_(lout, m, n, a, lda, idigit, ifmt, ifmt_len)
integer *lout, *m, *n;
doublereal *a;
integer *lda, *idigit;
char *ifmt;
...
/*     integer i_len(), s_wsfe(), do_fio(), e_wsfe(); */
    ...
    /* Local variables */
    static char line[80];
    static integer i__, j, k1, k2, ndigit, lll;
