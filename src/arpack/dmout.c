...
/* Subroutine */ int igraphdmout_(integer *lout, integer *m, integer *n, 
	doublereal *a, integer *lda, integer *idigit, char *ifmt)
{
    /* Initialized data */
...
/*     /\* Builtin functions *\/ */
/*     integer s_wsfe(cilist *), do_fio(integer *, char *, */
/* 	     ftnlen), e_wsfe(void); */
