...
igraph_integer_t igraph_transitivity_avglocal_undirected(const igraph_t *graph,
        igraph_real_t *res,
    ...
    for (i = 0; i < no_of_nodes; i++) {
        VECTOR(rank)[ (igraph_integer_t) VECTOR(order)[i] ] = no_of_nodes - i - 1;
    }
    ...
    for (nn = no_of_nodes - 1; nn >= 0; nn--) {
        node = (igraph_integer_t) VECTOR(order)[nn];
...
igraph_integer_t igraph_transitivity_local_undirected1(const igraph_t *graph,
        igraph_vector_t *res,
...
igraph_integer_t igraph_transitivity_local_undirected2(const igraph_t *graph,
        igraph_vector_t *res,
        const igraph_vs_t vids,
        igraph_transitivity_mode_t mode) {
    ...
    for (i = 0; i < nodes_to_calc; IGRAPH_VIT_NEXT(vit), i++) {
        ...
        for (j = 0; j < neilen; j++) {
            igraph_integer_t nei = (igraph_integer_t) VECTOR(*neis2)[j];
    ...
    for (i = 0; i < affected_nodes; i++) {
        igraph_integer_t v = (igraph_integer_t) VECTOR(avids)[i];
        igraph_vector_t *neis2;
    ...
    for (i = 0; i < affected_nodes; i++) {
        VECTOR(rank)[ (igraph_integer_t) VECTOR(order)[i] ] = affected_nodes - i - 1;
    }
    ...
    for (nn = affected_nodes - 1; nn >= 0; nn--) {
        igraph_integer_t node = (igraph_integer_t) VECTOR(avids) [ (igraph_integer_t) VECTOR(order)[nn] ];
        igraph_vector_t *neis1, *neis2;
        igraph_integer_t neilen1, neilen2;
        igraph_integer_t nodeindex = (igraph_integer_t) VECTOR(indexv)[node];
        igraph_integer_t noderank = (igraph_integer_t) VECTOR(rank) [nodeindex - 1];

        /*     fprintf(stderr, "node %li (indexv %li, rank %li)\n", node, */
        /*      (igraph_integer_t)VECTOR(indexv)[node]-1, noderank); */
        ...
        for (i = 0; i < neilen1; i++) {
            igraph_integer_t nei = (igraph_integer_t) VECTOR(*neis1)[i];
            igraph_integer_t neiindex = (igraph_integer_t) VECTOR(indexv)[nei];
            igraph_integer_t neirank = (igraph_integer_t) VECTOR(rank)[neiindex - 1];
            ...
            if (neirank > noderank) {
                ...
                for (j = 0; j < neilen2; j++) {
                    igraph_integer_t nei2 = (igraph_integer_t) VECTOR(*neis2)[j];
                    igraph_integer_t nei2index = (igraph_integer_t) VECTOR(indexv)[nei2];
                    igraph_integer_t nei2rank = (igraph_integer_t) VECTOR(rank)[nei2index - 1];
    ...
    for (i = 0; i < nodes_to_calc; i++, IGRAPH_VIT_NEXT(vit)) {
        ...
        igraph_integer_t idx = (igraph_integer_t) VECTOR(indexv)[node] - 1;
        igraph_vector_t *neis2 = igraph_lazy_adjlist_get(&adjlist,
                                 (igraph_integer_t) node);
        igraph_integer_t deg = igraph_vector_size(neis2);
...
/* igraph_integer_t igraph_transitivity_local_undirected3(const igraph_t *graph, */
/*                    igraph_vector_t *res, */
/*                    const igraph_vs_t vids) { */
...
igraph_integer_t igraph_i_trans4_al_simplify(igraph_adjlist_t *al,
    ...
    for (i = 0; i < n; i++) {
        ...
        VECTOR(mark)[i] = i + 1;
        for (j = 0; j < l; /* nothing */) {
            igraph_integer_t e = (igraph_integer_t) VECTOR(*v)[j];
...
igraph_integer_t igraph_transitivity_local_undirected4(const igraph_t *graph,
        igraph_vector_t *res,
        igraph_transitivity_mode_t mode) {
...
igraph_integer_t igraph_transitivity_local_undirected(const igraph_t *graph,
        igraph_vector_t *res,
        const igraph_vs_t vids,
        igraph_transitivity_mode_t mode) {
...
igraph_integer_t igraph_adjacent_triangles1(const igraph_t *graph,
                               igraph_vector_t *res,
                               const igraph_vs_t vids) {
# include "properties/triangles_template1.h"
    return 0;
...
igraph_integer_t igraph_adjacent_triangles4(const igraph_t *graph,
                               igraph_vector_t *res) {
# include "properties/triangles_template.h"
    return 0;
}
...
igraph_integer_t igraph_adjacent_triangles(const igraph_t *graph,
                              igraph_vector_t *res,
                              const igraph_vs_t vids) {
    if (igraph_vs_is_all(&vids)) {
 ...
 *        is stored here, in a igraph_integer_t list of triples of vertex ids.
...
igraph_integer_t igraph_list_triangles(const igraph_t *graph,
...
igraph_integer_t igraph_transitivity_undirected(const igraph_t *graph,
                                   igraph_real_t *res,
                                   igraph_transitivity_mode_t mode) {
...
igraph_integer_t igraph_transitivity_barrat1(const igraph_t *graph,
                                igraph_vector_t *res,
                                const igraph_vs_t vids,
                                const igraph_vector_t *weights,
                                igraph_transitivity_mode_t mode);

igraph_integer_t igraph_transitivity_barrat4(const igraph_t *graph,
                                igraph_vector_t *res,
                                const igraph_vs_t vids,
                                const igraph_vector_t *weights,
                                igraph_transitivity_mode_t mode);
...
igraph_integer_t igraph_transitivity_barrat1(const igraph_t *graph,
    ...
    for (i = 0; !IGRAPH_VIT_END(vit); IGRAPH_VIT_NEXT(vit), i++) {
        ...
        for (j = 0; j < adjlen1; j++) {
            igraph_integer_t edge = (igraph_integer_t) VECTOR(*adj1)[j];
        ...
        for (j = 0; j < adjlen1; j++) {
            igraph_integer_t edge1 = (igraph_integer_t) VECTOR(*adj1)[j];
            ...
            for (k = 0; k < adjlen2; k++) {
                igraph_integer_t edge2 = (igraph_integer_t) VECTOR(*adj2)[k];
...
igraph_integer_t igraph_transitivity_barrat4(const igraph_t *graph,
    ...
    for (nn = no_of_nodes - 1; nn >= 0; nn--) {
        ...
        igraph_integer_t node = (igraph_integer_t) VECTOR(order)[nn];
        ...
        /* Mark the neighbors of the node */
        for (i = 0; i < adjlen1; i++) {
            igraph_integer_t edge = (igraph_integer_t) VECTOR(*adj1)[i];
            igraph_integer_t nei = IGRAPH_OTHER(graph, edge, node);
        ...
        for (i = 0; i < adjlen1; i++) {
            igraph_integer_t edge1 = (igraph_integer_t) VECTOR(*adj1)[i];
            igraph_real_t weight1 = VECTOR(*weights)[edge1];
            ...
            if (VECTOR(rank)[nei] > VECTOR(rank)[node]) {
                ...
                for (j = 0; j < adjlen2; j++) {
                    igraph_integer_t edge2 = (igraph_integer_t) VECTOR(*adj2)[j];
...
igraph_integer_t igraph_transitivity_barrat(const igraph_t *graph,
                               igraph_vector_t *res,
                               const igraph_vs_t vids,
                               const igraph_vector_t *weights,
                               igraph_transitivity_mode_t mode) {
